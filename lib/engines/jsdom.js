 ...
 * Initialize the page
 */
JSDomEngine.prototype.init = function(html, initCallback, errorCallback, pageCreateCallback) {
  var _this = this;
  ...
  d.run(function() {
    try {
      jsdom.defaultDocumentFeatures = _this.config.engineSettings;
      _this.document = jsdom.jsdom(html);
        _this.pageCreateCallback(_this.phantom.page, function() {
          ...
          _this.window.location.href = _this.config.baseUrl;
