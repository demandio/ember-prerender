...
PrerenderRenderer.prototype.rendererInit = function(page) {
  this.engine.init(
    cluster.worker.id,
    page,
    _.bind(this.afterRendererInit, this),  // Success callback
    function () {}  // Error callback: ignore errors
    //_.bind(this.shutdown, this, 1)  // Error callback: restart on errors
  );
};
