 ...
 */
PrerenderRenderer.prototype.onEnginePageCreate = function(page, callback) {
  this.pluginEvent('enginePageCreate', [this.engine, page], callback);
};
...
*/
PrerenderRenderer.prototype.jobFinished = function() {
  this.job = null;
};
