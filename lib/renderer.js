...
PrerenderRenderer.prototype.rendererInit = function(page) {
  this.engine.init(
    cluster.worker.id, page,
    _.bind(this.afterRendererInit, this),
    _.bind(this.shutdown, this, true)
  );
};
